...
WebUI.callTestCase(findTestCase('BLOCKS/Login Success and Custom Keyword'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BLOCKS/Booking Appointment Success'), [:], FailureHandling.STOP_ON_FAILURE)
