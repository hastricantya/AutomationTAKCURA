...
WebUI.setText(findTestObject('IF ELSE SCRIPT MODE/input_Visit Date (Required)_visit_date'), VisitDate)

WebUI.setText(findTestObject('Object Repository/P.BA01-Booking Appointment (Positive)/INPUT/textarea_Comment'), Comment)
...
WebUI.verifyElementText(findTestObject('IF ELSE SCRIPT MODE/lbl_isi_date'), VisitDate)

WebUI.verifyElementText(findTestObject('Page_Appointment_Confirmation/lbl_isi_program'), 'Medicaid')

WebUI.verifyElementText(findTestObject('IF ELSE SCRIPT MODE/lbl_isi_komen'), Comment)
