...
if (hospital_readmission == true) {
    WebUI.verifyElementText(findTestObject('Object Repository/P.BA01-Booking Appointment (Positive)/INPUT/input_Apply for hospital'), 
        'Yes')
} else {
    WebUI.verifyElementText(findTestObject('Object Repository/P.BA01-Booking Appointment (Positive)/INPUT/input_Apply for hospital'), 
        'No', FailureHandling.OPTIONAL)
}
